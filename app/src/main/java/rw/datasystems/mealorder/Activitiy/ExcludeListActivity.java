 ...
 */
public class ExcludeListActivity extends AppCompatActivity {
    ...
    ExcludeListActivity.DisconnectTask disconnectTask;
    private View view;
...
//                break;
            ...
            case R.id.disc:
                ...
                mActivateButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (disconnectTask == null) {
                            ...
                            disconnectTask = new ExcludeListActivity.DisconnectTask(finalMUsername1.getText().toString(), finalMPassword1.getText().toString());
                ...
                if (view.getParent() == null) {
                    dialog = new Dialog(ExcludeListActivity.this);
                    ...
                    mActivateButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (disconnectTask == null) {
                                ...
                                disconnectTask = new ExcludeListActivity.DisconnectTask(finalMUsername.getText().toString(), finalMPassword.getText().toString());
                                disconnectTask.execute((Void)null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Constants.orderitems.size() > 0)
            recyclerView.setAdapter(new OrderItemAdapter(ExcludeListActivity.this, false, Constants.orderitems));
        ...
        catname.setText("Exclude Anything?");
        ...
        recyclerView.setAdapter(new NewComponentAdapter(getApplicationContext(), Constants.currentItem.components));
    ...
    View.OnClickListener finish = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            List<Component> excluded = new ArrayList<Component>(Constants.excluded.values());
            oitem2.excluded = excluded;

            Constants.pendingOrderItem = oitem2;

            if(oitem2.item.side_dishes != null && oitem2.item.side_dishes.size() > 0)
            {

                Constants.orderitems.remove(Constants.orderitems.size() - 1);

                Intent intent = new Intent(getApplicationContext(), SideDishActivity.class);
            ...
            else if(oitem2.item.related != null && oitem2.item.related.size() > 0) {
    ...
    private void changeLanguage() {
        ...
        if (Constants.lang == 1) {
            ...
            Constants.lang = 2;
            catname.setText("Exclure quelque chose ?");
            yourordertext.setText("Votre commande");
