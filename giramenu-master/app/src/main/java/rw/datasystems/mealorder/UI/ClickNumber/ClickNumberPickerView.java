...
public class ClickNumberPickerView extends PercentRelativeLayout {
    ...
    private View.OnClickListener leftPickerListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            ...
            if(!Constants.controlPicker)
                updatePickerValueByStep(-step);
            else
                _updatePickerValueByStep(-step);
        }
    };

    private View.OnClickListener rightPickerListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if (animationSwipeEnabled) {
    ...
    public void _setPickerValue(float value) {
        if(value < minValue || value > maxValue) {
            return;
        }
    ...
    public void _updatePickerValueByStep(float step) {
        if(value + step < minValue) {
            clickNumberPickerListener.onValueChange(minValue, value, minValue > value ? PickerClickType.LEFT : PickerClickType.RIGHT);
           // setPickerValue(minValue);
        } else if (value + step > maxValue) {
            clickNumberPickerListener.onValueChange(maxValue, value, maxValue > value ? PickerClickType.LEFT : PickerClickType.RIGHT);
           // setPickerValue(maxValue);
        }

        clickNumberPickerListener.onValueChange(value, value + step, value + step < value ? PickerClickType.LEFT : PickerClickType.RIGHT);
